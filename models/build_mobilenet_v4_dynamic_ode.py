""" MobileNet V4 Dynamic ODE Models
...
@register_model
def mobilenetv4_dynamic_ode_conv_small(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs) -> MobileNetV4:
    """ MobileNet V4 Dynamic+ODE alternating Conv Small """
    model = _gen_dynamic_ode_mobilenet_v4('mobilenetv4_dynamic_ode_conv_small', 1.0, pretrained=pretrained, **kwargs)
    return model


@register_model
def mobilenetv4_dynamic_ode_conv_medium(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs) -> MobileNetV4:
    """ MobileNet V4 Dynamic+ODE alternating Conv Medium """
    model = _gen_dynamic_ode_mobilenet_v4('mobilenetv4_dynamic_ode_conv_medium', 1.0, pretrained=pretrained, **kwargs)
    return model


@register_model
def mobilenetv4_dynamic_ode_conv_large(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs) -> MobileNetV4:
    """ MobileNet V4 Dynamic+ODE alternating Conv Large """
    model = _gen_dynamic_ode_mobilenet_v4('mobilenetv4_dynamic_ode_conv_large', 1.0, pretrained=pretrained, **kwargs)
    return model


@register_model
def mobilenetv4_dynamic_ode_hybrid_medium(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs) -> MobileNetV4:
    """ MobileNet V4 Dynamic+ODE alternating Hybrid Medium """
    model = _gen_dynamic_ode_mobilenet_v4('mobilenetv4_dynamic_ode_hybrid_medium', 1.0, pretrained=pretrained, **kwargs)
    return model


@register_model
def mobilenetv4_dynamic_ode_hybrid_large(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs) -> MobileNetV4:
    """ MobileNet V4 Dynamic+ODE alternating Hybrid Large """
    model = _gen_dynamic_ode_mobilenet_v4('mobilenetv4_dynamic_ode_hybrid_large', 1.0, pretrained=pretrained, **kwargs)
    return model
